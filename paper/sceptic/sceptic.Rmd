...
```{r sens_tab}
sens_ord = c('alt-gmst', 'me-gmst', 'me-forcings', 'eff1', 'eff2', 'anthro')
sens_labs = c('CW2014' = 'cw', 'giss' = 'GISTEMP', 'ME GMST' = 'me-gmst', 'ME forcings'= 'me-forcings', 'Eff1' = 'eff1', 'Eff2' = 'eff2', 'Anthro' = 'anthro', 'CO2' = 'co2')
sens_tab[, series := factor(series, levels = sens_ord)]
setorder(sens_tab, series)
sens_tab[, Comment := fcase(run=='alt-gmst', 'Alternative GMST series.',
														series=='me-gmst', 'Specifies measurement error in HadCRUT4',
														series=='me-forcings', 'Introduces measurement error in forcings data.',
														series=='eff1', 'Adjusted forcing efficacies (means).',
														series=='eff2', 'Adjusted forcing efficacies (distributions).',
														series=='anthro', 'Separates anthropogenic from natural forcings.',
														series=='co2', 'Separates CO\\$_2\\$ from natural forcings.'
														)]
sens_tab[, run := NULL]
setnames(sens_tab, c('series', 'tcr'), c('Key', 'TCR'))

kbl(sens_tab, align = 'lll', booktabs = TRUE, format = 'latex',
