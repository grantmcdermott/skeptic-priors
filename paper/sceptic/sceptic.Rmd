...
Beliefs about climate change are powerful. They dictate our choices as individuals and policies as societies. Our beliefs also affect how we interpret information about the world. For a climate sceptic, as for anyone else, beliefs provide a lens through which new information is subjectively interrogated and made intelligible. Naturally, this is not to say that beliefs are immutable. A central theme of Bayesianism --- the intellectual framework for this paper --- is the process by which beliefs are updated through exposure to new information. But our responsiveness to this new information will depend greatly on the certainty with which we hold our existing beliefs. 
<!-- Exactly *how* great of an effect is the focus of this paper. -->
...
I test the sensitivity of my findings to a range of potential data issues and model specifications. 
...
However, the general effect of these alternate specifications is to nudge the posterior TCR mean \textit{higher}. 
